    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_timestamp', models.DateTimeField(auto_now_add=True, verbose_name='Created timestamp')),
                ('update_timestamp', models.DateTimeField(auto_now=True, verbose_name='Updated timestamp')),
                ('badge', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='badges.badge')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='badges.badge')),
            ],
            options={
                'verbose_name': 'badge Translation',
                'db_table': 'badges_badge_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
